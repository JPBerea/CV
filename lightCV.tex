...
\newcommand{\otherThemeRef}{\href{https://github.com/JPBerea/CV/blob/master/darkCV.pdf}{\color{urlcolor}
 Tema oscuro {\faicon{lightbulb-o}}}}
\newcommand{\latestVersion}{\href{https://github.com/wilmeragsgh/resume/raw/master/wilmer_gonzalez_light.pdf}{\color{urlcolor}
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  %\href{https://github.com/wilmeragsgh}{  \color{urlcolor}{\faicon{github}} 
  %\color{textcolor} wilmeragsgh}\\
  %\href{maybe}{\color{urlcolor}{\faicon{film}} \underline{\textsl{video 
  %introduction}}}
\end{tabular*}
...
\section{Educación}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Facultad de Ciencias, UNAM}{Fecha estimada de graduación: noviembre 2024}
      \resumeItemListStart
...
\resumeSubItem{\textbf{Lenguajes de programación:} Java, Python, R, Julia}

\resumeSubItem{\textbf{Bibliotecas para análisis de datos:} Pandas, NumPy, 
	Tidyverse}

\resumeSubItem{\textbf{Manejo de base de datos:} MySQL, SQLite}

\resumeSubItem{\textbf{Visualización de Datos:} Matplotlib, Ggplot2, 
	Mathematica}

\resumeSubItem{\textbf{Otras herramientas:} Excel, GIT, GitHub, Azure cloud, 
	Jupyter notebooks}
