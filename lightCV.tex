...
\newcommand{\latestVersion}{\href{https://github.com/JPBerea/CV/blob/master/lightCV.pdf}{\color{urlcolor}
...
% HEADING
		...
		Java, 
		Python, R, intermedio en el uso de Julia}
		
		\resumeSubItem{\textbf{Bibliotecas para análisis de datos:} Pandas, 
		NumPy, 
			Tidyverse}
		...
		\resumeSubItem{\textbf{Otras herramientas:} GIT, Azure cloud, GitHub, 
		Excel, 
		Jupyter notebooks}
